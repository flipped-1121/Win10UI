YL.static = {
  /** “关于”信息 */
  softwareName: "Kang's Blog", //网站名。请在此处填写您自己的网站名，如王小明的博客。
  version: "1.0.0", // 网站版本号
  iconBtnStart: 'html5', //主图标
  author: 'YLUI',//作者
  contactInformation: 'https://t.me/flipped1121',//联系方式
  officialWebsite: 'https://kangblogs.top',//软件官网
  welcome: '嘿！这里是 Kang 的站点\n更多信息：//kangblogs.top',//加载完毕控制台提示信息
